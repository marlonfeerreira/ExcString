...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Exibe a última palavra na diagonal invertida
    echo "<h2>Última Palavra na Diagonal Invertida:</h2>";
    for ($i = 0; $i < strlen($ultimaPalavra); $i++) {
        // Adiciona espaços para alinhar a diagonal invertida
        echo str_repeat("&nbsp;", strlen($ultimaPalavra) - $i - 1);
